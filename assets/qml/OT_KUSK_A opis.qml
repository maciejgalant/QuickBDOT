...
<qgis maxScale="1000" minScale="5000" hasScaleBasedVisibilityFlag="1" simplifyAlgorithm="0" version="3.12.1-București" simplifyMaxScale="1" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="1" simplifyDrawingTol="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontSizeUnit="MapUnit" blendMode="0" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="1" fontWeight="50" fontFamily="Arial" fontKerning="1" fontCapitals="0" useSubstitutions="0" fontSize="18" fieldName=" wordwrap( NAZWA, 25 ) " previewBkgrdColor="255,255,255,255" multilineHeight="1" namedStyle="Italic" fontUnderline="0" fontLetterSpacing="0" textOrientation="horizontal" fontWordSpacing="0" textColor="0,0,0,255" fontItalic="1" textOpacity="1">
        <text-buffer bufferJoinStyle="64" bufferSize="4.5" bufferSizeUnits="MapUnit" bufferDraw="1" bufferNoFill="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferColor="255,255,255,255" bufferOpacity="0.55"/>
      ...
      <placement fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="PolygonGeometry" repeatDistanceUnits="MM" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" overrunDistance="0" centroidWhole="1" geometryGeneratorEnabled="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" placement="1" repeatDistance="0" yOffset="0" distUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" quadOffset="4" maxCurvedCharAngleOut="-20" priority="8" offsetUnits="MapUnit" maxCurvedCharAngleIn="20" placementFlags="10" preserveRotation="1" dist="0" geometryGeneratorType="PointGeometry" offsetType="0" xOffset="0" geometryGenerator=""/>
      <rendering zIndex="0" obstacleFactor="1" mergeLines="0" minFeatureSize="0" limitNumLabels="0" fontMinPixelSize="3" scaleVisibility="0" fontMaxPixelSize="10000" scaleMax="10000000" scaleMin="1" maxNumLabels="2000" obstacleType="0" drawLabels="1" labelPerPart="0" upsidedownLabels="0" obstacle="0" displayAll="1" fontLimitPixelSize="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" value="" type="QString"/>
          <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias field="nazwa" index="25" name=""/>
