...
<qgis minScale="10001" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyDrawingHints="1" readOnly="1" version="3.12.0-București" labelsEnabled="0" maxScale="1000" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" simplifyMaxScale="1">
  ...
  <aliases>
    ...
    <alias field="idKSOCH" index="25" name=""/>
    <alias field="idNatura" index="26" name=""/>
    <alias field="nazwa" index="27" name=""/>
    <alias field="koniecWersjiObiektu" index="28" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="idKSOCH" expression=""/>
    <default applyOnUpdate="0" field="idNatura" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="wersjaId" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="czyObiektBDOO" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_kod" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_skrKarto" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_katDoklGeom" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_doklGeom" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_doklGeom_uom" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_zrodloDanychG" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_zrodloDanychA" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_katIstnienia" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_rodzajReprGeom" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_aktualnoscG" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_aktualnoscA" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="poczatekWersjiObiektu" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_dataUtworzenia" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_kodKarto10k" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_kodKarto25k" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_kodKarto50k" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_kodKarto100k" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_kodKarto250k" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_kodKarto500k" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="x_kodKarto1000k" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="idKSOCH" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="idNatura" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="nazwa" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="koniecWersjiObiektu" notnull_strength="0" unique_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="idKSOCH" exp="" desc=""/>
    <constraint field="idNatura" exp="" desc=""/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" width="-1" name="czyObiektBDOO"/>
      <column type="field" hidden="0" width="-1" name="x_kod"/>
      <column type="field" hidden="0" width="-1" name="x_skrKarto"/>
      <column type="field" hidden="0" width="-1" name="x_katDoklGeom"/>
      <column type="field" hidden="0" width="-1" name="x_zrodloDanychG"/>
      <column type="field" hidden="0" width="-1" name="x_zrodloDanychA"/>
      <column type="field" hidden="0" width="-1" name="x_katIstnienia"/>
      <column type="field" hidden="0" width="-1" name="x_rodzajReprGeom"/>
      <column type="field" hidden="0" width="-1" name="x_aktualnoscG"/>
      <column type="field" hidden="0" width="-1" name="x_aktualnoscA"/>
      <column type="field" hidden="0" width="-1" name="poczatekWersjiObiektu"/>
      <column type="field" hidden="0" width="-1" name="x_dataUtworzenia"/>
      <column type="field" hidden="0" width="-1" name="x_kodKarto10k"/>
      <column type="field" hidden="0" width="-1" name="x_kodKarto25k"/>
      <column type="field" hidden="0" width="-1" name="x_kodKarto50k"/>
      <column type="field" hidden="0" width="-1" name="x_kodKarto100k"/>
      <column type="field" hidden="0" width="-1" name="x_kodKarto250k"/>
      <column type="field" hidden="0" width="-1" name="x_kodKarto500k"/>
      <column type="field" hidden="0" width="-1" name="x_kodKarto1000k"/>
      <column type="field" hidden="0" width="-1" name="idNatura"/>
      <column type="field" hidden="0" width="-1" name="x_doklGeom"/>
      <column type="field" hidden="0" width="-1" name="x_doklGeom_uom"/>
      <column type="field" hidden="0" width="-1" name="idKSOCH"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="idKSOCH"/>
    <field editable="1" name="idNatura"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="idKSOCH"/>
    <field labelOnTop="0" name="idNatura"/>
