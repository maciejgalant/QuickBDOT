...
<qgis maxScale="1000" minScale="5000" hasScaleBasedVisibilityFlag="1" simplifyAlgorithm="0" version="3.12.1-București" simplifyMaxScale="1" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="1" simplifyDrawingTol="1">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontSizeUnit="MapUnit" blendMode="0" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="1" fontWeight="50" fontFamily="Arial" fontKerning="1" fontCapitals="0" useSubstitutions="0" fontSize="18" fieldName=" wordwrap( NAZWA, 26)" previewBkgrdColor="255,255,255,255" multilineHeight="1" namedStyle="Italic" fontUnderline="0" fontLetterSpacing="0" textOrientation="horizontal" fontWordSpacing="0" textColor="0,0,0,255" fontItalic="1" textOpacity="1">
        <text-buffer bufferJoinStyle="64" bufferSize="4.1" bufferSizeUnits="MapUnit" bufferDraw="1" bufferNoFill="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferColor="255,255,255,255" bufferOpacity="0.55"/>
        <text-mask maskEnabled="0" maskOpacity="1" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers="" maskType="0" maskSizeUnits="MM" maskSize="1.5" maskJoinStyle="64"/>
        <background shapeOffsetUnit="MM" shapeJoinStyle="64" shapeBorderWidth="0" shapeRotationType="0" shapeOffsetY="0" shapeRadiiX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiY="0" shapeFillColor="255,255,255,255" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM" shapeSizeType="0" shapeRadiiUnit="MM" shapeType="0" shapeBlendMode="0" shapeSizeY="0" shapeOffsetX="0" shapeSizeX="0" shapeBorderColor="128,128,128,255" shapeRotation="0" shapeSVGFile="" shapeSizeUnit="MM" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0">
        ...
        <shadow shadowOffsetAngle="135" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowColor="0,0,0,255" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowScale="100" shadowRadius="1.5" shadowRadiusAlphaOnly="0" shadowBlendMode="6" shadowOffsetGlobal="1" shadowUnder="0" shadowOffsetUnit="MM" shadowOpacity="0.7" shadowDraw="0" shadowOffsetDist="1" shadowRadiusUnit="MM"/>
        <dd_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <text-format formatNumbers="0" decimals="3" leftDirectionSymbol="&lt;" autoWrapLength="0" addDirectionSymbol="0" reverseDirectionSymbol="0" plussign="0" wrapChar="" rightDirectionSymbol=">" useMaxLineLengthForAutoWrap="1" multilineAlign="1" placeDirectionSymbol="0"/>
      <placement fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="PolygonGeometry" repeatDistanceUnits="MM" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" overrunDistance="0" centroidWhole="0" geometryGeneratorEnabled="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" placement="1" repeatDistance="0" yOffset="0" distUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" quadOffset="4" maxCurvedCharAngleOut="-20" priority="5" offsetUnits="MapUnit" maxCurvedCharAngleIn="20" placementFlags="10" preserveRotation="1" dist="0" geometryGeneratorType="PointGeometry" offsetType="0" xOffset="0" geometryGenerator=""/>
      <rendering zIndex="0" obstacleFactor="1" mergeLines="0" minFeatureSize="0" limitNumLabels="0" fontMinPixelSize="3" scaleVisibility="0" fontMaxPixelSize="10000" scaleMax="10000000" scaleMin="1" maxNumLabels="2000" obstacleType="0" drawLabels="1" labelPerPart="0" upsidedownLabels="0" obstacle="1" displayAll="0" fontLimitPixelSize="1"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" value="" type="QString"/>
          <Option name="properties"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Pie" attributeLegend="1">
    <DiagramCategory diagramOrientation="Up" spacingUnitScale="3x:0,0,0,0,0,0" backgroundAlpha="255" opacity="1" height="15" spacingUnit="MM" backgroundColor="#ffffff" barWidth="5" penAlpha="255" minScaleDenominator="1000" spacing="0" penColor="#000000" penWidth="0" maxScaleDenominator="1e+08" scaleBasedVisibility="0" rotationOffset="270" direction="1" lineSizeScale="3x:0,0,0,0,0,0" showAxis="0" sizeType="MM" lineSizeType="MM" minimumSize="0" scaleDependency="Area" width="15" labelPlacementMethod="XHeight" sizeScale="3x:0,0,0,0,0,0" enabled="0">
  ...
  <DiagramLayerSettings showAll="1" priority="0" dist="0" placement="0" linePlacementFlags="2" zIndex="0" obstacle="0">
    <properties>
      <Option type="Map">
        <Option name="name" value="" type="QString"/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias field="x_informDodatkowa" index="27" name=""/>
    <alias field="x_uwagi" index="28" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint field="lokalnyId" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="przestrzenNazw" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="wersjaId" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="czyObiektBDOO" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_kod" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_skrKarto" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_katDoklGeom" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_doklGeom" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_doklGeom_uom" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_zrodloDanychG" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_zrodloDanychA" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_katIstnienia" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_rodzajReprGeom" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_aktualnoscG" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_aktualnoscA" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="poczatekWersjiObiektu" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_dataUtworzenia" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_kodKarto10k" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_kodKarto25k" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_kodKarto50k" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_kodKarto100k" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_kodKarto250k" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_kodKarto500k" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_kodKarto1000k" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    ...
    <constraint field="x_informDodatkowa" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="x_uwagi" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="czyObiektBDOO" exp="" desc=""/>
    <constraint field="x_kod" exp="" desc=""/>
    <constraint field="x_skrKarto" exp="" desc=""/>
    <constraint field="x_katDoklGeom" exp="" desc=""/>
    <constraint field="x_doklGeom" exp="" desc=""/>
    <constraint field="x_doklGeom_uom" exp="" desc=""/>
    <constraint field="x_zrodloDanychG" exp="" desc=""/>
    <constraint field="x_zrodloDanychA" exp="" desc=""/>
    <constraint field="x_katIstnienia" exp="" desc=""/>
    <constraint field="x_rodzajReprGeom" exp="" desc=""/>
    <constraint field="x_aktualnoscG" exp="" desc=""/>
    <constraint field="x_aktualnoscA" exp="" desc=""/>
    <constraint field="poczatekWersjiObiektu" exp="" desc=""/>
    <constraint field="x_dataUtworzenia" exp="" desc=""/>
    <constraint field="x_kodKarto10k" exp="" desc=""/>
    <constraint field="x_kodKarto25k" exp="" desc=""/>
    <constraint field="x_kodKarto50k" exp="" desc=""/>
    <constraint field="x_kodKarto100k" exp="" desc=""/>
    <constraint field="x_kodKarto250k" exp="" desc=""/>
    <constraint field="x_kodKarto500k" exp="" desc=""/>
    <constraint field="x_kodKarto1000k" exp="" desc=""/>
    <constraint field="rodzaj" exp="" desc=""/>
    <constraint field="nazwa" exp="" desc=""/>
    <constraint field="x_informDodatkowa" exp="" desc=""/>
    <constraint field="x_uwagi" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
