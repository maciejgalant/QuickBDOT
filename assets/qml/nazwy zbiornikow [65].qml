...
<qgis maxScale="1000" symbologyReferenceScale="-1" simplifyDrawingTol="2" simplifyMaxScale="1" styleCategories="Symbology|Symbology3D|Labeling|Fields|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations|Temporal|Legend|Elevation|Notes" hasScaleBasedVisibilityFlag="1" minScale="10001" simplifyAlgorithm="0" simplifyLocal="1" labelsEnabled="1" simplifyDrawingHints="3" version="3.22.15-Białowieża">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textOpacity="1" fontKerning="1" legendString="Aa" allowHtml="0" textColor="17,150,206,255" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSize="20" isExpression="1" fontFamily="Cambria" fontSizeUnit="MapUnit" blendMode="0" fieldName="if(rodzaj&lt;>'woda płynąca',nazwa,'')" useSubstitutions="0" textOrientation="horizontal" capitalization="0" fontWeight="50" multilineHeight="1" fontUnderline="0" previewBkgrdColor="255,255,255,255" fontWordSpacing="0" fontLetterSpacing="0" namedStyle="Regular" fontItalic="0">
        <families/>
        ...
        <substitutions>
          <replacement caseSensitive="0" match="Kanał" wholeWord="1" replace="Kan."/>
        </substitutions>
      </text-style>
      ...
      <placement geometryGenerator=" centroid( difference($geometry,@map_extent))" dist="0" polygonPlacementFlags="2" overrunDistance="0" lineAnchorClipping="0" offsetUnits="MapUnit" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" priority="9" yOffset="-30" lineAnchorPercent="0.5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" maxCurvedCharAngleIn="20" repeatDistanceUnits="MM" placementFlags="9" maxCurvedCharAngleOut="-20" fitInPolygonOnly="0" geometryGeneratorEnabled="0" xOffset="0" centroidInside="1" repeatDistance="0" offsetType="0" preserveRotation="0" geometryGeneratorType="PointGeometry" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" overrunDistanceUnit="MM" placement="4" distUnits="MapUnit" centroidWhole="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="PolygonGeometry" quadOffset="4"/>
      <rendering minFeatureSize="0" scaleMax="10001" scaleMin="1" displayAll="0" fontMinPixelSize="3" zIndex="0" scaleVisibility="1" labelPerPart="0" unplacedVisibility="0" upsidedownLabels="0" maxNumLabels="2000" obstacleFactor="1.8" obstacle="1" limitNumLabels="0" fontMaxPixelSize="10000" mergeLines="0" obstacleType="1" drawLabels="1" fontLimitPixelSize="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties" type="Map">
            <Option name="FontLetterSpacing" type="Map">
              ...
              <Option value="bounds_width(  $geometry )/500" name="expression" type="QString"/>
              <Option value="3" name="type" type="int"/>
            </Option>
            <Option name="MultiLineHeight" type="Map">
            ...
            <Option name="MultiLineWrapChar" type="Map">
              <Option value="true" name="active" type="bool"/>
              <Option value="if (bounds_width(  $geometry )*0.6&lt;  length(&quot;NAZWA&quot;)*10,' ','')" name="expression" type="QString"/>
              <Option value="3" name="type" type="int"/>
            </Option>
            <Option name="Size" type="Map">
              <Option value="true" name="active" type="bool"/>
              <Option value="CASE &#xd;&#xa;WHEN ($area>10000000) THEN 80&#xd;&#xa;WHEN ($area&lt;10000000 and $area>500000) THEN 50&#xd;&#xa;WHEN ($area&lt;500000 and $area>150000) THEN 30&#xd;&#xa;ELSE 20&#xd;&#xa;END" name="expression" type="QString"/>
              <Option value="3" name="type" type="int"/>
            </Option>
          </Option>
          <Option value="collection" name="type" type="QString"/>
  ...
  <customproperties>
    <Option type="Map">
      <Option name="dualview/previewExpressions" type="StringList">
        <Option value="COALESCE( &quot;SYS_ID&quot;, '&lt;NULL>' )" type="QString"/>
      </Option>
  ...
  <SingleCategoryDiagramRenderer diagramType="Pie" attributeLegend="1">
    <DiagramCategory spacing="0" lineSizeScale="3x:0,0,0,0,0,0" rotationOffset="270" backgroundColor="#ffffff" sizeScale="3x:0,0,0,0,0,0" minimumSize="0" spacingUnitScale="3x:0,0,0,0,0,0" barWidth="5" height="15" minScaleDenominator="1000" spacingUnit="MM" diagramOrientation="Up" showAxis="0" penColor="#000000" width="15" lineSizeType="MM" maxScaleDenominator="1e+08" opacity="1" scaleDependency="Area" scaleBasedVisibility="0" direction="1" backgroundAlpha="255" penWidth="0" enabled="0" labelPlacementMethod="XHeight" penAlpha="255" sizeType="MM">
  ...
  <DiagramLayerSettings zIndex="0" linePlacementFlags="2" priority="0" placement="0" dist="0" obstacle="0" showAll="1">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="ciek2_tmp" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="zbiornikWodny1_tmp" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="7" name="" field="informacjaDodatkowa"/>
    <alias index="8" name="" field="kodKarto10k"/>
    <alias index="9" name="" field="rodzaj"/>
    <alias index="10" name="" field="identyfikatorMPHP"/>
    <alias index="11" name="" field="nazwa"/>
    <alias index="12" name="" field="identyfikatorPRNG"/>
    <alias index="13" name="" field="ciek2_tmp"/>
    <alias index="14" name="" field="zbiornikWodny1_tmp"/>
    <alias index="15" name="" field="KOD10K"/>
  </aliases>
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="ciek2_tmp"/>
    <default expression="" applyOnUpdate="0" field="zbiornikWodny1_tmp"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" unique_strength="0" field="ciek2_tmp" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" unique_strength="0" field="zbiornikWodny1_tmp" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="ciek2_tmp" desc=""/>
    <constraint exp="" field="zbiornikWodny1_tmp" desc=""/>
    <constraint exp="" field="KOD10K" desc=""/>
  </constraintExpressions>
  <expressionfields>
    <field expression="regexp_substr(ciek2,'#(.*)')" precision="0" length="0" name="ciek2_tmp" typeName="string" comment="" subType="0" type="10"/>
    <field expression="regexp_substr(zbiornikWodny1,'#(.*)')" precision="0" length="0" name="zbiornikWodny1_tmp" typeName="string" comment="" subType="0" type="10"/>
    <field expression=" &quot;x_kodKarto10k&quot; " precision="0" length="0" name="KOD10K" typeName="string" comment="" subType="0" type="10"/>
  </expressionfields>
  <attributeactions>
    <defaultAction value="{00000000-0000-0000-0000-000000000000}" key="Canvas"/>
  </attributeactions>
  <attributetableconfig sortExpression="&quot;nazwa&quot;" actionWidgetStyle="dropDown" sortOrder="1">
    <columns>
      <column width="-1" hidden="1" type="actions"/>
      <column name="ciek2_tmp" width="-1" hidden="1" type="field"/>
      <column name="zbiornikWodny1_tmp" width="-1" hidden="1" type="field"/>
      <column name="KOD10K" width="-1" hidden="1" type="field"/>
      ...
      <column name="informacjaDodatkowa" width="163" hidden="0" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field name="BD500_ID" editable="1"/>
    <field name="BD500_PNA" editable="1"/>
    <field name="BD500_WEID" editable="1"/>
    <field name="CIEK3_NIL" editable="1"/>
    <field name="CI_DLUGOSC" editable="1"/>
    <field name="CI_IDPRNG" editable="1"/>
    <field name="CI_NAZWA" editable="1"/>
    <field name="CI_PRNG_ID" editable="1"/>
    <field name="CI_PRNG_PN" editable="1"/>
    <field name="CI_PRNG_WE" editable="1"/>
    <field name="GMLID" editable="1"/>
    <field name="IDMPHP" editable="1"/>
    <field name="KATISTNIEN" editable="1"/>
    <field name="KATIST_NIL" editable="1"/>
    <field name="KOD1000K" editable="1"/>
    <field name="KOD1000_NI" editable="1"/>
    <field name="KOD100K" editable="1"/>
    <field name="KOD100_NIL" editable="1"/>
    <field name="KOD10K" editable="0"/>
    <field name="KOD10K_NIL" editable="1"/>
    <field name="KOD250K" editable="1"/>
    <field name="KOD250_NIL" editable="1"/>
    <field name="KOD25K" editable="1"/>
    <field name="KOD25K_NIL" editable="1"/>
    <field name="KOD500K" editable="1"/>
    <field name="KOD500_NIL" editable="1"/>
    <field name="KOD50K" editable="1"/>
    <field name="KOD50K_NIL" editable="1"/>
    <field name="KONIECWERS" editable="1"/>
    <field name="LOKALNYID" editable="1"/>
    <field name="PL.PZGiK.238.2476__OT_Ciek_nazwa" editable="0"/>
    <field name="PL.PZGiK.238.2476__OT_ZbiornikWodny_nazwa" editable="0"/>
    <field name="PL.PZGiK.330.1465__OT_Ciek_nazwa" editable="0"/>
    <field name="PL.PZGiK.330.1465__OT_ZbiornikWodny_nazwa" editable="0"/>
    <field name="PL.PZGiK.333.0803__OT_ZbiornikWodny_nazwa" editable="0"/>
    <field name="PL.PZGiK.341.2816__OT_Ciek_nazwa" editable="0"/>
    <field name="PL.PZGiK.341.2816__OT_ZbiornikWodny_nazwa" editable="0"/>
    <field name="PL.PZGiK.370.2604__OT_Ciek_nazwa" editable="0"/>
    <field name="PL.PZGiK.370.2604__OT_ZbiornikWodny_nazwa" editable="0"/>
    <field name="PL.PZGiK.994.0401__OT_Ciek_nazwa" editable="0"/>
    <field name="PL.PZGiK.994.0401__OT_ZbiornikWodny_nazwa" editable="0"/>
    <field name="PNAZW" editable="1"/>
    <field name="POCZWERS" editable="1"/>
    <field name="POZIOMWODY" editable="1"/>
    <field name="PRNG_LOKID" editable="1"/>
    <field name="PRNG_PNAZW" editable="1"/>
    <field name="PRNG_WERID" editable="1"/>
    ...
    <field name="X_AKTA" editable="1"/>
    <field name="X_AKTG" editable="1"/>
    <field name="X_DATAUTW" editable="1"/>
    <field name="X_DOKLGEOM" editable="1"/>
    <field name="X_INFDOD" editable="1"/>
    <field name="X_KATDOKG" editable="1"/>
    <field name="X_KATIST" editable="1"/>
    <field name="X_KATI_NIL" editable="1"/>
    <field name="X_KOD" editable="1"/>
    <field name="X_RODZREPG" editable="1"/>
    <field name="X_SKRKARTO" editable="1"/>
    <field name="X_SKRK_NIL" editable="1"/>
    <field name="X_UWAGI" editable="1"/>
    <field name="X_UZYTKOWN" editable="1"/>
    <field name="X_ZRODLOA" editable="1"/>
    <field name="X_ZRODLOG" editable="1"/>
    <field name="ZBWODN_NIL" editable="1"/>
    <field name="ZB_BD10_ID" editable="1"/>
    <field name="ZB_BD10_PN" editable="1"/>
    <field name="ZB_BD10_WE" editable="1"/>
    <field name="ZB_IDPRNG" editable="1"/>
    <field name="ZB_NAZWA" editable="0"/>
    <field name="ZB_X_AKTA" editable="1"/>
    <field name="ZB_X_INFD" editable="1"/>
    <field name="area" editable="1"/>
    <field name="ciek2" editable="1"/>
    <field name="ciek2_tmp" editable="0"/>
    ...
    <field name="zbiornikWodny1_tmp" editable="0"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="PL.PZGiK.341.2816__OT_ZbiornikWodny_nazwa"/>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="ciek2_tmp"/>
    ...
    <field reuseLastValue="0" name="zbiornikWodny1_tmp"/>
