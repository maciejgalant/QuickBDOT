...
<qgis maxScale="1000" symbologyReferenceScale="-1" simplifyDrawingTol="1" simplifyMaxScale="1" styleCategories="Symbology|Symbology3D|Labeling|Fields|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations|Temporal|Legend|Elevation|Notes" hasScaleBasedVisibilityFlag="1" minScale="10001" simplifyAlgorithm="0" simplifyLocal="1" labelsEnabled="1" simplifyDrawingHints="1" version="3.22.15-Białowieża">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textOpacity="1" fontKerning="1" legendString="Aa" allowHtml="0" textColor="0,145,202,255" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSize="10" isExpression="1" fontFamily="Cambria" fontSizeUnit="Point" blendMode="0" fieldName="if (&quot;KOD10K&quot; IN ( '0010_606', '0010_610'), if (  &quot;STATUSEKS&quot;  = 'żeglowny', upper( &quot;NAZWA&quot; ),NAZWA),IF (szerokosc&lt;= 20,NAZWA,''))" useSubstitutions="0" textOrientation="horizontal" capitalization="0" fontWeight="50" multilineHeight="1" fontUnderline="0" previewBkgrdColor="243,243,238,255" fontWordSpacing="0.21875" fontLetterSpacing="0.65625" namedStyle="Regular" fontItalic="0">
        <families/>
        <text-buffer bufferSizeUnits="MM" bufferDraw="0" bufferSize="0" bufferOpacity="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferNoFill="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128"/>
        <text-mask maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskedSymbolLayers="" maskEnabled="0" maskOpacity="1" maskType="0" maskSize="0" maskSizeUnits="MM"/>
        <background shapeSizeX="0" shapeRotationType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeBorderWidthUnit="Point" shapeDraw="0" shapeOffsetUnit="Point" shapeRadiiY="0" shapeRadiiUnit="Point" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeSizeY="0" shapeOffsetY="0" shapeSVGFile="" shapeOffsetX="0" shapeRotation="0" shapeJoinStyle="64" shapeBorderWidth="0" shapeType="0" shapeSizeUnit="Point" shapeFillColor="255,255,255,255" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeRadiiX="0">
        ...
        <shadow shadowDraw="0" shadowBlendMode="6" shadowOffsetUnit="Point" shadowOffsetGlobal="1" shadowRadiusUnit="Point" shadowOffsetDist="1" shadowScale="100" shadowOffsetAngle="135" shadowRadius="1.5" shadowRadiusAlphaOnly="0" shadowOpacity="1" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowUnder="0" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowColor="0,0,0,255"/>
        <dd_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
      ...
      <text-format addDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" decimals="3" leftDirectionSymbol="&lt;" wrapChar="" formatNumbers="0" placeDirectionSymbol="0" reverseDirectionSymbol="0" autoWrapLength="0" rightDirectionSymbol=">" plussign="0" multilineAlign="0"/>
      <placement geometryGenerator="" dist="0" polygonPlacementFlags="2" overrunDistance="4" lineAnchorClipping="0" offsetUnits="MM" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" priority="10" yOffset="0" lineAnchorPercent="0.5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" maxCurvedCharAngleIn="29" repeatDistanceUnits="MM" placementFlags="14" maxCurvedCharAngleOut="-35" fitInPolygonOnly="0" geometryGeneratorEnabled="0" xOffset="0" centroidInside="0" repeatDistance="300" offsetType="0" preserveRotation="1" geometryGeneratorType="PointGeometry" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" overrunDistanceUnit="MM" placement="3" distUnits="MM" centroidWhole="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="LineGeometry" quadOffset="4"/>
      <rendering minFeatureSize="0" scaleMax="0" scaleMin="0" displayAll="0" fontMinPixelSize="3" zIndex="0" scaleVisibility="0" labelPerPart="0" unplacedVisibility="0" upsidedownLabels="0" maxNumLabels="2000" obstacleFactor="1" obstacle="1" limitNumLabels="0" fontMaxPixelSize="10000" mergeLines="1" obstacleType="1" drawLabels="1" fontLimitPixelSize="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties"/>
  ...
  <attributetableconfig sortExpression="&quot;PL.PZGiK.341.2816__OT_Ciek_nazwa&quot;" actionWidgetStyle="dropDown" sortOrder="1">
    <columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="POLOZ_NIL"/>
    ...
    <field labelOnTop="0" name="SZER_NIL"/>
